...
import com.techelevator.matchmodel.MatchDao;
...
public class MatchStatsController {
	...
	public String displayMatchStats(HttpServletRequest request) {
		request.setAttribute("match",(matchDao.getOneMatch(request.getParameter("matchId"))));   // make getOneMatch
		request.setAttribute("wrestler", (wrestlerDao.getOneWrestler(request.getParameter("wrestlerId")))); // Believe I can scrap this 
		return "matchStats";
