...
public class IndividualStatsController {
	...
	@RequestMapping("/individualStats")
	public String displayIndividualStats(HttpServletRequest request) {
		request.setAttribute("matches",(matchDao.getAllMatches(request.getParameter("id"))));
		request.setAttribute("wrestler", (wrestlerDao.getOneWrestler(request.getParameter("id"))));
